...
//you can drag the view with the right mouse button
//won't work when the headset is connected.
namespace Zenva
{
    public class DragCamera : MonoBehaviour {
	    ...
	    void Update () {
            ...
            // skip if a HMD is connected
            if(XRDevice.isPresent) return;
		    
            // if we press the button and we haven't started dragging
            ...
            // if we are not pressing the button, and we were dragging
